...
# App QoE (E7–E8 old numbering → check new E7–E8 labels)
...
# ============================================================
# NEW PLOTS for short_label / ECN / Hybrid
# ============================================================

# 1. Grouped throughput by short_label (full experiment set)
...
# 2. Boxplot by short_label (to see variance)
...
# 3. R-Hybrid vs Baselines (CUBIC / BBR / DCTCP) — aggregated
...
# 4. ECN vs no-ECN: DCTCP vs CUBIC under ECN200M
